...
### Overview  
This week focuses on **Autonomous AI Agents**—AI systems designed to reason, plan, and act independently across tools and workflows. The goal is to move beyond single-prompt interactions and toward **goal-driven, multi-step agent behavior** suitable for real-world applications.
...
https://hf.co/learn/agents-course
